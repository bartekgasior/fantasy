					...
					<legend> Podaj dane</legend>
						...
						<div class = "form-group">
							<div class="col-lg-10">
								...
								<form:select path="real_team_id">
								   
								    <c:forEach items="${realTeams }" var="realTeam">
								        <form:option id="${realTeam.id }" value="${realTeam.id }" itemValue="real_team_id">${realTeam.name }</form:option>   
								    </c:forEach>
								</form:select>
